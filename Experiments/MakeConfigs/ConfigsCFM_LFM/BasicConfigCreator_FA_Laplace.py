...
class BasicConfigCreator():
    ...
    def set_data_generation_params(self):
        ...
        self.config['DATA_GENERATION'] = {
            "Pprogram": "fa_laplace", # probabilistic program to generate the data
    ...
    def set_model_params(
        ...
        K = int(ast.literal_eval(self.config['DATA_GENERATION']['pprogram_params'])['z_dim'])
...
if __name__ == "__main__":
    config_creator = BasicConfigCreator(
        config_name = "basic_config_fa_small_laplace",
