...
from PFNExperiments.LinearRegression.Models.SkipMLP_CNF import SkipMLPCNFConditionalDecoder
...
from PFNExperiments.Experiments.RunExperiments.RunExperimentsMLP import RunExperiments
    ...
    def setup_evaluation(self):
        ...
        if string2bool(self.config["EVALUATION"]["do_full_evaluation"]) is True:
            ...
            if "numpyro_hmc" in self.config["EVALUATION"].keys() and string2bool(self.config["EVALUATION"]["numpyro_hmc"]) is True:
                ...
                self.comparison_models = [self.comparison_models[0]]
